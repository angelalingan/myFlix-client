...
export class ProfileView extends React.Component {
    ...
    onRemoveFavorite = (movie) => {
        ...
        axios
            .delete(
                'https://myflixdb-myfirstapi.herokuapp.com/users/${username}/movies/${movie}',
    ...
    getUser = (token) => {
        const Username = localStorage.getItem("user");
        axios
            .get('https://myflixdb-myfirstapi.herokuapp.com/users/${Username}', {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((response) => {
                this.setState({
    ...
    editUser = (e) => {
        ...
        axios
            .put(
                'https://myflixdb-myfirstapi.herokuapp.comusers/${Username}',
                {
    ...
    onDeleteUser() {
        ...
        axios
            .delete('https://myflixdb-myfirstapi.herokuapp.com/users/${Username}', {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((response) => {
                console.log(response);
